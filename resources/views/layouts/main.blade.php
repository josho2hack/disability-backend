        ...
        <section id="footer">
            <div class="container p-0">
                <div class="row clearfix">
                    <div class="col-sm-12 col-md-9">
                        ...
                        <p>โทร. <a href="tel:+6621421202" class="footer-link">0 2142 1202</a> | แฟกซ์. <a
                                href="tel:+6621437962" class="footer-link">0 2143 7962</a> | อีเมล์. <a
                                href="mailto:pr.onde@onde.go.th" class="footer-link">pr.onde@onde.go.th</a> </p>
                    </div>
                    <div class="col-sm-12 col-md-3 text-center">
                        ...
                        <div class="row clearfix text-center">
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                --}}
                                <a href="https://www.youtube.com/channel/UCuCrGM49GT0kFdXMRDYqQRA/playlists"
                                    target="_blank">
                                    <img class="footer-icons"
                                        src="{{ asset('assets/images/footer-icons/youtube.png') }}" alt="Youtube">
                                </a>
                                {{-- </div> --}}
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                --}}
                                <a href="https://web.facebook.com/ONDE.GO.TH/" target="_blank">
                                    <img class="footer-icons" src="{{ asset('assets/images/footer-icons/fb.png') }}"
                                        alt="Facebook">
                                </a>
                                {{-- </div> --}}
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                ...
                                <a href="mailto:pr.onde@onde.go.th" target="_blank">
                                    <img class="footer-icons" src="{{ asset('assets/images/footer-icons/mail.png') }}"
                                        alt="E-mail">
                                </a>
                                {{-- </div> --}}
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                ...
                                <a href="https://twitter.com/ONDE_GO_TH" target="_blank">
                                    <img class="footer-icons"
                                        src="{{ asset('assets/images/footer-icons/twitter.png') }}" alt="Twitter">
                                </a>
                                {{-- </div> --}}
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                --}}
                                <a href="https://www.instagram.com/onde_go_th/" target="_blank">
                                    <img class="footer-icons"
                                        src="{{ asset('assets/images/footer-icons/instagram.png') }}" alt="Instagram">
                                </a>
                                {{-- </div> --}}
                            {{-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                --}}
                                <a href="http://line.me/ti/p/%40uvj2550p" target="_blank">
                                    <img class="footer-icons"
                                        src="{{ asset('assets/images/footer-icons/Line_icon.png') }}" alt="Line">
                                </a>
                                {{-- </div> --}}
                        </div>
                    </div>
            ...
            <div class="row clearfix p-0 m-0" style="background: #382851;">
                <div class="container p-0 text-center pt-15 pb-15">
                    <h5>สงวนลิขสิทธิ์ © 2563 สำนักงานคณะกรรมการดิจิทัลเพื่อเศรษฐกิจและสังคมแห่งชาติ</h5>
                </div>
            </div>
        </section>
    </div>
