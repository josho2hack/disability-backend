    ...
    <div class="boxs">
        <div class="boxs-body" style="width: auto; margin: auto; padding: 15px 80px;">
                ...
                <div class="form-group">
                    ...
                    ครั้งที่ <input type="text" name="round" value="{{ $audits->round }}" readonly style="width:5%;"> ประจำปีงบประมาณ <input type="text" name="year" value="{{ $audits->year }}" style="width:10%;" readonly><br>
                    หน่วยงานที่รับคำขอฯ <input type="text" name="office" value="{{ $audits->office }}" style="width:15%;" required readonly> จังหวัด <input type="text" name="city" value="{{ $audits->office }}" style="width:12%;" required readonly>
                    </div>
                </div>
                ...
                <div class="text-right">
                    <a href="{{ url('auditor/pdf', $audits->id) }}" class="btn btn-raised btn-info"><i class="fa fa-print"></i> | ดู PDF</a>
                </div>
        </div>
    </div>
@endsection
