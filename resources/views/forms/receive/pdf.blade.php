...
<body>
	...
	<div class="header">
		แบบคำขอรับอุปกรณ์และเครื่องมือเทคโนโลยีสิ่งอำนวยความสะดวกเพื่อการสื่อสาร<br>
	ตามกฎกระทรวงฯ
	</div>
	<div class="write-at"><br>
...
@endphp --}}
	...
	<div class="title">
		เรื่อง	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ขอรับอุปกรณ์และเครื่องมือเทคโนโลยีสิ่งอำนวยความสะดวกเพื่อการสื่อสาร ตามกฎกระทรวงฯ 
	</div>
	<div class="subtitle">
	...
	<div class="detail-2"><br><br><br><br>	
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีความประสงค์ขอรับอุปกรณ์/เครื่องมือ เทคโนโลยีสิ่งอำนวยความสะดวกเพี่อการสื่อสาร<br>ให้แก่
		<div class="name2">
			นาย กอไก้ กอไผ่{{-- {{ $form->user->title }}&nbsp;&nbsp;{{ $form->user->first_name }}&nbsp;&nbsp;{{ $form->user->last_name }} --}}
		</div>
