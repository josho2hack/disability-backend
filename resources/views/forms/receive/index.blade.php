                ...
                <div class="boxs-widget">
                    <div class="form-group">
                        ...
                        <div class="btn-group pull-right">
                            <a href="{{ url('form-receive/create') }}" class="btn btn-success btn-raised">สร้างแบบฟอร์มขอรับเดี่ยว (ทก.02)</a>
                        </div>
                        @endif
                        {{-- @if ($form->count() < 1)
                        <div class="btn-group pull-right">
                            <a href="{{ url('form-receive/create') }}" class="btn btn-success btn-raised">สร้างแบบฟอร์มกลุ่ม (ทก.01)</a>
                        </div>
                        @endif --}}
                    </div>
                </div>
