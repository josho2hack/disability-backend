...
<body id="falcon" class="authentication">
  <div class="wrapper">
    <div class="header header-filter" style="background-image: url('assets/images/administrator_login.png'); background-size: cover; background-position: top center;">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                <div class="header header-primary text-center" style="background: linear-gradient(45deg, #9966cc, #9498b1);">
