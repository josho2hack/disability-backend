        ...
        <div class="col-md-12">
            <section class="boxs">
                ...
                <div class="boxs-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" action="{{ route('eventcategories.update',$eventcategory->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" placeholder="" value="{{ $eventcategory->name }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="description" placeholder="" value="{{ $eventcategory->description }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">สี</label>
                            <div class="col-sm-10">
                                <input name="color" type="text" id="text-field" class="form-control colorpicker" value="{{ $eventcategory->color }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-raised btn-success">บันทึก</button>
                                <a href="{{ route('eventcategories.index') }}" class="btn btn-raised btn-default">ยกเลิก</a>
                            </div>
                        </div>
                    </form>
                </div>
