                ...
                <div class="b-b mb-10">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <h1 class="font-thin h3 m-0">จัดการไฟล์</h1>
                        </div>
                        {{-- <div class="btn-group pull-right">
                            <a href="{{ url('fileupload/add') }}" class="btn btn-warning btn-raised">เพิ่มไฟล์</a>
                        </div> --}}
                    </div>
                </div>
                <!-- row -->
                        ...
                        <section class="boxs">
                            <div class="boxs-header">
                                <h3 class="custom-font hb-cyan">
                                    <strong>รายละเอียดไฟล์ </strong></h3>
                            </div>
                            <div class="boxs-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="boxs-body">
                                            <form class="form-horizontal" action="{{ url('fileupload') }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="news_picture" class="col-sm-2 control-label">เพิ่มไฟล์</label>
                                                    <div class="col-sm-10">
